...
namespace techTask2.Migrations
{
    ...
    [Migration("20230504113725_InitialCreate4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("techTask2.Models.ApplicationOwnerAndOperator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("ApplicationOwnerAndOperators");
                });

            modelBuilder.Entity("techTask2.Models.Operator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("techTask2.Models.ApplicationOwnerAndOperator", b =>
                {
                    b.HasOne("techTask2.Models.Operator", "Operator")
                        .WithMany("ApplicationOwnerAndOperators")
                    ...
                    b.HasOne("techTask2.Models.Transport", "Transport")
                        .WithOne("ApplicationOwnerAndOperator")
                        .HasForeignKey("techTask2.Models.ApplicationOwnerAndOperator", "TransportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("techTask2.Models.Operator", b =>
                {
                    b.Navigation("ApplicationOwnerAndOperators");
                });
            ...
            modelBuilder.Entity("techTask2.Models.Transport", b =>
                {
                    b.Navigation("ApplicationOwnerAndOperator");
